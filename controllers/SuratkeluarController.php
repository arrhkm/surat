...
use app\components\SmartIncrementKeyDb;
...
class SuratkeluarController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $model->nomor_surat = $model->getLastNomor();
        ...
        if ($model->load(Yii::$app->request->post())){ 
            ...
            if (!empty($model->imageFile)){       
                $model->file_surat = "{$model->nomor_surat}.{$model->imageFile->extension}";            
                $model->save();
                $model->upload();
            }else {
                $model->save();
    ...
    public function actionCobaupload(){
        ...
        return $this->render('cobaupload', ['model' => $model]);
